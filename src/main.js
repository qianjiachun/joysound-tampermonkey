...
// @version      2022.02.12.04
// @description  🎵✨通用网页视频音效增强/优化。Enhance/Optimize video sound in web.
// @match        *://*/*
// @include      *://*/*
// @connect      yximgs.com
// @resource joysoundjs https://cdn.jsdelivr.net/gh/qianjiachun/joysound-tampermonkey@1.0/src/static/joysound.js
// @grant        unsafeWindow
...
const JS_VERSION = "2022.02.12"; // js版本号，如有变动请修改这个值重新获取
...
function getJs() {
    const STR = "b.safari";
    let ret = GM_getResourceText("joysoundjs");
